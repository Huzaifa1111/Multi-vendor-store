...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    this.triggerSpeedUp = this.triggerSpeedUp.bind(this);
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {}, isHyper = false }) => {
  ...
  useEffect(() => {
    if (appRef.current) {
      appRef.current.triggerSpeedUp(isHyper);
    }
  }, [isHyper]);
