                ...
                >
                    <div className="max-w-2xl">
                        <div className="flex items-center gap-2 mb-4 text-emerald-600">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-[0.4em]">Curated Collection</span>
                        </div>
                        ...
                        <p className="text-gray-500 text-lg font-medium max-w-md leading-relaxed">
                            A refined selection of pieces you've reserved for future acquisition. Excellence awaits.
                        </p>
                    </div>

                    <div className="flex items-center gap-6 pb-2">
                        <div className="text-right hidden sm:block">
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Total Treasures</p>
                    ...
                    {items.length === 0 ? (
                        ...
                        >
                            ...
                            <div className="relative z-10 max-w-md mx-auto">
                                ...
                                <h2 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">Elegantly Empty</h2>
                                <p className="text-gray-500 font-medium mb-12 leading-relaxed">
                                    Your personal gallery is awaiting its first selection. Explore our latest arrivals to begin your curation.
                                </p>
